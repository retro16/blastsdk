...
extern int64_t d68k(char *_targetdata, int _tsize, const u8 *_code, int _size, int _instructions, u32 _address, int _labels, int _showaddresses, int _showcycles, int *_suspicious);
