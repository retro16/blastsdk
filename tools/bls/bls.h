...
extern sv_t d68k(char *target, int tsize, const u8 *code, int size, int instructions, sv_t address, int labels, int showcycles, int *suspicious);
...
extern u32 subreadlong(u32 address);
extern u32 subreadword(u32 address);
extern u32 subreadbyte(u32 address);
